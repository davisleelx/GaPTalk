...
import numpy as np
from gaussian_splatting.utils.general_utils import PILtoTorch, ArrayToTorch
...
def loadCam(args, id, cam_info, resolution_scale):
    orig_w, orig_h = cam_info.image.size if cam_info.image is not None else (512, 512)
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T,
                  ...
                  exp_coeffs=cam_info.exp_coeffs,
                  mask=cam_info.mask,)
